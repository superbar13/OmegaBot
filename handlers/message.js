        ...
        client.on('messageCreate', async message => {
            ...
            for (let option of options) {
                if (getArg(option.name)) {
                    ...
                    if (option.type == 10 && message.options.getNumber(option.name) === null) {
